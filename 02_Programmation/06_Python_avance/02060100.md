...
::::{admonition} Exemples
:::{code} python
# Définition d'une variable pour stocker le nombre d'utilisateurs
nombre_utilisateurs = 12
...
**Versionner le code**
- Utilisez un système de gestion de versions comme `git` pour suivre les modifications du code.
...
- Validez toujours les entrées utilisateur pour éviter les injections de code.
- Utilisez des bibliothèques et des frameworks sécurisés et maintenus.
