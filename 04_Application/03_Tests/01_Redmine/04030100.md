...
::::{card}
:header: **Suivi des demandes**
:::{image} ./static/issues-list.png
:alt: Liste des demandes Redmine
:width: 100%
:::
Tickets typés (anomalie, évolution, tâche…), statuts, priorités, assignations, relations et sous-tâches.
::::

::::{card}
:header: **Roadmap & Gantt**
:::{image} ./static/gantt.png
:alt: Gantt Redmine
:width: 100%
:::
Planification par versions, diagramme de Gantt natif, roadmap par jalons.
::::
